...
if [ "${my_function_11_prototype+1}" = "1" ] ; then echo $my_function_11_prototype_str '= "'$my_function_11_prototype'";'>>"$string_file" ; fi
if [ "${my_function_12_prototype+1}" = "1" ] ; then echo $my_function_12_prototype_str '= "'$my_function_12_prototype'";'>>"$string_file" ; fi
if [ "${my_function_13_prototype+1}" = "1" ] ; then echo $my_function_13_prototype_str '= "'$my_function_13_prototype'";'>>"$string_file" ; fi
if [ "${my_function_14_prototype+1}" = "1" ] ; then echo $my_function_14_prototype_str '= "'$my_function_14_prototype'";'>>"$string_file" ; fi
if [ "${my_function_15_prototype+1}" = "1" ] ; then echo $my_function_15_prototype_str '= "'$my_function_15_prototype'";'>>"$string_file" ; fi
if [ "${my_function_16_prototype+1}" = "1" ] ; then echo $my_function_16_prototype_str '= "'$my_function_16_prototype'";'>>"$string_file" ; fi
