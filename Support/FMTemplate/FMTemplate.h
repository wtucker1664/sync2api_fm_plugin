...
#define __FMTemplate_h__
  ...
  //  Include additional FM Template headers so that FMTemplate.h is the only one required
    ...
    extern FMX_PROC(fmx::errcode) FUNCTION_12_C_NAME(short, const fmx::ExprEnv&, const fmx::DataVect&, fmx::Data&);
    #endif
    #ifdef FUNCTION_13_C_NAME
    extern FMX_PROC(fmx::errcode) FUNCTION_13_C_NAME(short, const fmx::ExprEnv&, const fmx::DataVect&, fmx::Data&);
    #endif
    #ifdef FUNCTION_14_C_NAME
    extern FMX_PROC(fmx::errcode) FUNCTION_14_C_NAME(short, const fmx::ExprEnv&, const fmx::DataVect&, fmx::Data&);
    #endif
    #ifdef FUNCTION_15_C_NAME
    extern FMX_PROC(fmx::errcode) FUNCTION_15_C_NAME(short, const fmx::ExprEnv&, const fmx::DataVect&, fmx::Data&);
    #endif
    #ifdef FUNCTION_16_C_NAME
    extern FMX_PROC(fmx::errcode) FUNCTION_16_C_NAME(short, const fmx::ExprEnv&, const fmx::DataVect&, fmx::Data&);
    #endif
