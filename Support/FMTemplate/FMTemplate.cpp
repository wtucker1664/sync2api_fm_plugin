...
{   
    ...
    fmx::uint32              regFunction1Flags  = 0 | FUNCTION_1_FLAGS;
    #endif
    #ifdef FUNCTION_2_C_NAME
    fmx::uint32              regFunction2Flags  = 0 | FUNCTION_2_FLAGS;
    #endif
    #ifdef FUNCTION_3_C_NAME
    fmx::uint32              regFunction3Flags  = 0 | FUNCTION_3_FLAGS;
    #endif
    #ifdef FUNCTION_4_C_NAME
    fmx::uint32              regFunction4Flags  = 0 | FUNCTION_4_FLAGS;
    #endif
    #ifdef FUNCTION_5_C_NAME
    fmx::uint32              regFunction5Flags  = 0 | FUNCTION_5_FLAGS;
    #endif
    #ifdef FUNCTION_6_C_NAME
    fmx::uint32              regFunction6Flags  = 0 | FUNCTION_6_FLAGS;
    #endif
    #ifdef FUNCTION_7_C_NAME
    fmx::uint32              regFunction7Flags  = 0 | FUNCTION_7_FLAGS;
    #endif
    #ifdef FUNCTION_8_C_NAME
    fmx::uint32              regFunction8Flags  = 0 | FUNCTION_8_FLAGS;
    #endif
    #ifdef FUNCTION_9_C_NAME
    fmx::uint32              regFunction9Flags  = 0 | FUNCTION_9_FLAGS;
    #endif
    #ifdef FUNCTION_10_C_NAME
    fmx::uint32              regFunction10Flags  = 0 | FUNCTION_10_FLAGS;
    #endif
    #ifdef FUNCTION_11_C_NAME
    fmx::uint32              regFunction11Flags  = 0 | FUNCTION_11_FLAGS;
    #endif
    #ifdef FUNCTION_12_C_NAME
    fmx::uint32              regFunction12Flags  = 0 | FUNCTION_12_FLAGS;
    #endif
    #ifdef FUNCTION_13_C_NAME
    fmx::uint32              regFunction13Flags  = 0 | FUNCTION_13_FLAGS;
    #endif
    #ifdef FUNCTION_14_C_NAME
    fmx::uint32              regFunction14Flags  = 0 | FUNCTION_14_FLAGS;
    #endif
    #ifdef FUNCTION_15_C_NAME
    fmx::uint32              regFunction15Flags  = 0 | FUNCTION_15_FLAGS;
    #endif
    #ifdef FUNCTION_16_C_NAME
    fmx::uint32              regFunction16Flags  = 0 | FUNCTION_16_FLAGS;
    #endif
    ...
    #endif
    #ifdef FUNCTION_12_C_NAME
    err = RegisterExternalFunction( 12, FUNCTION_12_PARAMS, regFunction12Flags, FUNCTION_12_C_NAME );
    if_error(err,bail11);
    #endif
    #ifdef FUNCTION_13_C_NAME
    err = RegisterExternalFunction( 13, FUNCTION_13_PARAMS, regFunction13Flags, FUNCTION_13_C_NAME );
    if_error(err,bail12);
    #endif
    #ifdef FUNCTION_14_C_NAME
    err = RegisterExternalFunction( 14, FUNCTION_14_PARAMS, regFunction14Flags, FUNCTION_14_C_NAME );
    if_error(err,bail13);
    #endif
    #ifdef FUNCTION_15_C_NAME
    err = RegisterExternalFunction( 15, FUNCTION_15_PARAMS, regFunction15Flags, FUNCTION_15_C_NAME );
    if_error(err,bail14);
    #endif
    #ifdef FUNCTION_16_C_NAME
    err = RegisterExternalFunction( 16, FUNCTION_16_PARAMS, regFunction16Flags, FUNCTION_16_C_NAME );
    if_error(err,bail15);
    #endif
    //...
    ...
    goto bail;
#ifdef FUNCTION_16_C_NAME
    UnRegisterExternalFunction( 16 );
bail15:
#endif
#ifdef FUNCTION_15_C_NAME
UnRegisterExternalFunction( 15 );
bail14:
#endif
#ifdef FUNCTION_14_C_NAME
UnRegisterExternalFunction( 14 );
bail13:
#endif
#ifdef FUNCTION_13_C_NAME
UnRegisterExternalFunction( 13 );
bail12:
#endif
#ifdef FUNCTION_12_C_NAME
UnRegisterExternalFunction( 12 );
bail11:
#endif
#ifdef FUNCTION_11_C_NAME
...
void UnRegisterExternalFunctions()
{
    ...
    #ifdef FUNCTION_16_C_NAME
    (void) fmx::ExprEnv::UnRegisterExternalFunction(*pluginID, 16 );
    #endif
    #ifdef FUNCTION_15_C_NAME
    (void) fmx::ExprEnv::UnRegisterExternalFunction(*pluginID, 15 );
    #endif
    #ifdef FUNCTION_14_C_NAME
        (void) fmx::ExprEnv::UnRegisterExternalFunction(*pluginID, 14 );
    #endif
    #ifdef FUNCTION_13_C_NAME
        (void) fmx::ExprEnv::UnRegisterExternalFunction(*pluginID, 13 );
    #endif
    #ifdef FUNCTION_12_C_NAME
        (void) fmx::ExprEnv::UnRegisterExternalFunction(*pluginID, 12 );
    #endif
    #ifdef FUNCTION_11_C_NAME
